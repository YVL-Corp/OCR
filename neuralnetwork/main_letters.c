...
int main(int argc, char *argv[]) {
    ...
    if (argc < 3) {
        ...
        fprintf(stderr, "  Predict:    %s predict <grid_folder> <model_file.bin> <output_file.txt>\n", argv[0]);
        fprintf(stderr, "  Words:      %s words <words_folder> <model_file.bin> <output_file.txt>\n", argv[0]);
        fprintf(stderr, "\nExamples:\n");
        ...
        fprintf(stderr, "  %s predict ./grid_images model.bin grid.txt\n", argv[0]);
        fprintf(stderr, "  %s words ./words_folder model.bin words.txt\n", argv[0]);
        return 1;
    }
